...
public class PersonSearchAdapter extends RecyclerView.Adapter<PersonSearchAdapter.MyViewHolder>{

    private Context mContext;
    private ArrayList<Photo> arrPhotos;

    public PersonSearchAdapter(Context mContext, ArrayList<Photo> arrPhotos){
